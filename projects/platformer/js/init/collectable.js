(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max, 100, 150, 0, 0);
        collectable.create(type.db, 200, 200, 0, 0);
        collectable.create(type.grace, 300, 250, 0, 0);
        collectable.create(type.kennedi, 400, 300, 0, 0);
